// Purpose of this software: Kalman filter with fake measurements.
// Assuming a simple scenario with Lidar measurements and where Lidar measurements have already been
// analyzed accordingly

// Compiling this software:
// 1. Run the g++ initial_kalman.cpp file in the same directory as this file
// 2. It needs to have the Eigen files in the same directory
...
// Refer to the usual equations for solving the Kalman filter.
// As of now, we will not go through the maths to derive the required equations as it can 
// become too involved, making it hard to even start coding something out
...
void testing_out_engine(){
	...
	// Need to be able to do the following operations to get started with the Kalman filters
	// 1. Transpose the matrix
	// 2. Inverse the matirix
	// 3. Multiply matrix together - matrix multiplication 
}
